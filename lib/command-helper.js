...
export default class CommandHelper {
  ...
  constructor() {
    this.config = atom.config.get('shell-scripts');
    console.log(atom.config.get('shell-scripts.development.logToFile'));
  ...
  _populateEnvVariables() {
    ...
    if (relativizedPath[0] !== undefined && relativizedPath[1] !== undefined) {
